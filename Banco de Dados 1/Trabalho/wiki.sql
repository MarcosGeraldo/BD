...
CREATE TABLE Postagem(
	...
	IndentificacaoPostagem SERIAL,
	DataComentario DATE,
	Comentario VARCHAR(500),
	CONSTRAINT FK_InterageComunidade FOREIGN KEY(IdentificacaoInterageComunidade)
		REFERENCES Interage (IdentificacaoComunidade)
		ON DELETE CASCADE
		ON UPDATE CASCADE,
	CONSTRAINT FK_InterageColaborador FOREIGN KEY(IdentificacaoInterageColaborador)
		REFERENCES Interage (IdentificacaoColaborador)
		ON DELETE CASCADE
		ON UPDATE CASCADE,
	CONSTRAINT PK_Postagem PRIMARY KEY(IdentificacaoInterageComunidade,IdentificacaoInterageColaborador,IndentificacaoInteragePostagem)
);
...
CREATE TABLE Episodio (
	...
	CONSTRAINT FK_IdentificacaoEpisodio FOREIGN KEY(IdentificacaoSerie)
		...
		ON DELETE CASCADE
		ON UPDATE CASCADE,
		CONSTRAINT PK_Serie PRIMARY KEY(IdentificacaoSerie,Numero)
);
